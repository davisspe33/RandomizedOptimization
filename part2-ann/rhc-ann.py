...
def plotaccuracy(x,y):
    ...
    for z in range(1,1001,10):
        clf = mlrose.NeuralNetwork(hidden_nodes = [], activation = 'relu', \
                                    algorithm = 'random_hill_climb', max_iters = z, \
                                    bias = True, is_classifier = True, learning_rate = 0.0001, \
    ...
    axes[0].plot(param_range, accuracy, label="random_hill_climb",color="blue", lw=2)
    ...
    axes[1].plot(param_range, times, label="random_hill_climb",color="blue", lw=2)
